...
GM.Config.printeroverheatchance         = 34
...
"Common Intergalactic Law has been agreed upon as follows:",
"Violence is only justified in self defense.",
"Private property is protected.",
"Every being has the right to a fulfilled and peaceful life.",
"Local law and customs may differ regionally.",
}
...
GM.Config.minHitDistance = 50
-- The text that tells the player he can press use on the hitman to request a hit.
GM.Config.hudText = "I am an assasin.\nPress E on me to request an inhumation!"
-- The text above a hitman when he's got a hit.
GM.Config.hitmanText = "At your\n service"
